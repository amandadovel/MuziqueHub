                ...
                <div className="d-flex w-100">
                    <div className="svg-wrapper pr-3">
                        <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="50px" height="50px" viewBox="0 0 468.859 468.859" xmlSpace="preserve">
                            <g>
                                <path className="outer-headphone" fill="white" d="M235.554,0C109.784,0,3.532,102.367,3.532,223.536c0,68.314,33.927,149.905,86.43,207.865l1.484,1.639l2.164-0.429
                                ...
                                <path className="circle" fill="white" d="M350.25,318.652c27.303-52.329,42.647-100.296,31.242-107.756c-0.269-0.172-0.585-0.265-0.874-0.391
                                ...
                                <path className="music-note" fill="white" d="M247.696,93.629c-8.111-1.381-14.741,4.59-14.741,12.818v84.997c-4.795-1.759-9.959-2.771-15.371-2.771
